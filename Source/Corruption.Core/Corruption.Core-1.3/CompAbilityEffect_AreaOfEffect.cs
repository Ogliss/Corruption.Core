...
{
    public class CompAbilityEffect_AreaOfEffect : CompAbilityEffect
    {
        public new CompProperties_AreaOfEffect Props => this.props as CompProperties_AreaOfEffect;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            {
                foreach (var effect in this.parent.EffectComps.Where(x => x is CompAbilityEffect_AreaOfEffect == false))
                {
    ...
    public class CompProperties_AreaOfEffect : CompProperties_AbilityEffect
    {
        ...
        public CompProperties_AreaOfEffect()
        {
            this.compClass = typeof(CompAbilityEffect_AreaOfEffect);
        }
    }
