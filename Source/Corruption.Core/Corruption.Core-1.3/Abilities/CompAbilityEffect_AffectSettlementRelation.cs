...
namespace Corruption.Core.Abilities
{
    public class CompAbilityEffect_AffectSettlementRelation : CompAbilityEffect
    {
        ...
        public override void Apply(GlobalTargetInfo target)
        {
            ...
            {
                faction.TryAffectGoodwillWith(this.parent.pawn.Faction, this.Props.goodwillImpact, false, true, CorruptionHistoryEventDefOf.LeaderExperiencedVision, target);
            }
        }
    }
